  ...
  for ($x=0; $x<$info["count"]; $x++) {
   ...
   /*********** Check if record has been created for this user, if not create one ************/
	...
	if($search_row_cnt < 1){
		...
		$mysqli->query("INSERT INTO users_ldap (users_id, user_un, user_full_name) VALUES ('$this_users_id', '$ldap_sam', '$ldap_giv $ldap_sn')") or die($mysqli->error);
