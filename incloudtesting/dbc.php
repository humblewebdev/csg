...
3. MySQL user name with ALL privileges assigned.
4. MySQL password
...
/*************** reCAPTCHA KEYS****************/
$publickey = "6LchUNgSAAAAAPAfKeHAXj-r8dI6uR1l1jHTsDHV";
$privatekey = "6LchUNgSAAAAAJX5yBzaYGtB9xOEwmRySZ06j6WX";
...
//Function to Fix the ability to Send Email Auto-Responses -Zach
...
{
	if (preg_match('/^[0-9]{2,2}-[0-9]{2,2}-[0-9]{2,2}$/i', $username)) {
		return true;
	} else {
		return false;
	}
