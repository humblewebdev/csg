	...
	<div class="">
		<div class="well <?php echo $info_ui_color; ?>">
			...
			<div class="well-content no-search">
				...
				Print "<img src='profile_pics/$info_profile_pic' align='left' style='margin: 5px; width: 89px; height: 109px; border: 3px solid #fff;'	/>";
	...
	<div class="">
		<div class="well <?php echo $info_ui_color; ?>">
			...
			<div class="well-content no-search">
				...
				<strong>Agent Code</strong><br><?php Print "".$info_agent_code  . " ";   ?>
				<br>
				<strong>Email</strong><br><?php Print "".$info_email  . " ";   ?>
				<br>
				<strong>Address</strong><br><?php Print "".$info_address  . ", " . $info_city . ", " . $info_state . ", " . $info_zipcode;   ?>
				<br>
				<strong>Fax #</strong><br><?php Print "".formatPhone($info_fax)  . " ";   ?>
				<br>
			</div>
		</div>
	</div>
...
<div class="span6">
			...
			<div class="well-content no-search">
				...
				<tr >
					<td style="border-bottom: 1px solid #23628d;">
						...
						<?php if(${"info_staffpoition".$istaff} != NULL){ ?><tr><td><strong>POSITION: </strong></td><td><?php Print "".${"info_staffposition".$istaff}  . " ";   ?></td></tr><?php } ?>
	...
	<div class="">			
		<?php $fromMYSQL = $info_portal_update_time ; Print "<center><b>Last Updated:</b> ". date('l, m/d/Y \a\t g:i:sa',$info_portal_update_time) . "</center><br>"; ?>	
	</div>
	...
	<div class="">
			<div class="well <?php echo $info_ui_color; ?>">
				<div class="well-header">
					...
					<h5>Hours of operation (Show/Hide)</h5>
					</div>
				</div>
				...
				<div class="well-content no-search">
					...
					<tr>
						<td>Monday</td>
						<td><?php Print "".$info_mopen  . " ";   ?></td>
						<td>to</td>
						<td><?php Print "".$info_mclose  . " ";   ?></td>
					</tr>
					<tr>
						<td>Tuesday</td>
						<td><?php Print "".$info_topen  . " ";   ?></td>
						<td>to</td>
						<td><?php Print "".$info_tclose  . " ";   ?></td>
					</tr>
					<tr>
						<td>Wednesday</td>
						<td><?php Print "".$info_wopen  . " ";   ?></td>
						<td>to</td>
						<td><?php Print "".$info_wclose  . " ";   ?></td>
					</tr>
					<tr>
						<td>Thursday</td>
						<td><?php Print "".$info_ropen  . " ";   ?></td>
						<td>to</td>
						<td><?php Print "".$info_rclose  . " ";   ?></td>
					</tr>
					<tr>
						<td>Friday</td>
						<td><?php Print "".$info_fopen  . " ";   ?></td>
						<td>to</td>
						<td><?php Print "".$info_fclose  . " ";   ?></td>
					</tr>
					<tr>
						<td>Saturday</td>
						<td><?php if($info_saopen == $info_saclose){ echo "Closed"; } else{ Print "".$info_saopen  . " ";  } ?></td>
						<td>to</td>
						<td><?php if($info_saopen == $info_saclose){ echo "Closed"; } else{ Print "".$info_saclose  . " ";  } ?></td>
					</tr>
					<tr>
						<td>Sunday</td>
...
<!-- Script to show/hide NonEdit More div -->
    <script>
	$('#ipagestaff').click(function() {
	$('.ipagestaff').fadeToggle();
	 return false;
	});
	
	$('#ipagehoo').click(function() {
	$('.ipagehoo').fadeToggle();
	 return false;
	});
	
	<?php foreach($products_approved as $pa){ //Only show approved product sections?>
	$('.prod_id_<?php echo $pa['product_id']; ?>').show();
	<?php } ?>
