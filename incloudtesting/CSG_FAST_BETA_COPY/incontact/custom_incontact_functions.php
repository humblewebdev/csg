...
//(16)/***************************************************** /End skill_GetList Function/ Start of string_sanitize_phone Function***********************************************/

function string_sanitize_phone($s) {
    $result = preg_replace("/[^0-9]+/", "", html_entity_decode($s, ENT_QUOTES));
    return $result;
}
