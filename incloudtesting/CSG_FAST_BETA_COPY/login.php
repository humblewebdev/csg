    ...
    <div class="login-container">
        ...
        <form id="login_form" name="login_form" enctype="multipart/form-data">
            <div class="login-field">
				...
				<div class="field">
					<input type="text" name="username" class="required" id="username" placeholder="Email Address">
					<i class="icon-user"></i>
				</div>
            </div>
            <div class="login-field">
...
<!--PASSWORD UPDATE POPUP -->	
	<div id="reset-pw" class="modal hide fade" tabindex="-1" data-width="760">
            ...
            <div class="row-fluid">
                <div class="span12">
					...
					<form id="pwd_update_form" name="login_form" enctype="multipart/form-data">
                        <label class="field_name">Confirm Email</label>
                        <div class="field">
                            <div class="row-fluid">
