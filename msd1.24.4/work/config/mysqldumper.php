...
$config['dbport'] = '';
$config['dbsocket'] = '';
$config['manual_db'] = 'csg_fast_prod';
$config['minspeed'] = '100';
...
$databases['Name'][0] = '#mysql50#csginside_wp - Copy';
$databases['Name'][1] = 'beta_dental';
$databases['Name'][2] = 'csg_company';
$databases['Name'][3] = 'csg_fast_prod';
$databases['Name'][4] = 'csginside_v3';
$databases['Name'][5] = 'csginside_v4';
$databases['Name'][6] = 'csginside_wp';
$databases['Name'][7] = 'information_schema';
$databases['Name'][8] = 'mysql';
$databases['Name'][9] = 'mytestdb';
$databases['Name'][10] = 'nssoluti_csgfast';
$databases['Name'][11] = 'performance_schema';
...
$databases['db_actual'] = 'mytestdb';
$databases['multi']=array();
$databases['multi'][0] = 'csg_fast_prod';
$databases['multi'][1] = 'mytestdb';
$databases['multi_praefix']=array();
$databases['multi_praefix'][0] = '';
$databases['multi_praefix'][1] = '';
$databases['multisetting'] = 'csg_fast_prod;mytestdb';
