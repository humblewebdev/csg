		...
		<div class="well <?php echo $info_ui_color; ?>">
			...
			<div class="well-content no-search">
				<table class="table_hours" border="0" width="100%" style="background-color:#FFF;  z-index: 100; font-size: 11px;" cellpadding="2" cellspacing="3">
					...
					<tr><td><strong>ADDRESS: </strong><?php Print "".$info_address  . ", " . $info_city . ", " . $info_state . ", " . $info_zipcode;   ?></td>
					<td align="right"><a href="#" onclick="window.open('map_address.php?users_id=<?php echo $info_users_id; ?>', 'newwindow', 'width=550, height=500'); return false" class="btn blue"><i class="icon-map-marker"></i> &nbsp;View Map</a></td>
					</tr>
